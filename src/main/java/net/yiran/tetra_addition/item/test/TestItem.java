...
public class TestItem extends Item implements IModularItem , IToolProvider, InitializableItem {
    ...
    public @NotNull Rarity getRarity(@NotNull ItemStack itemStack) {
        return (Rarity)Optional.ofNullable(this.getPropertiesCached(itemStack)).map((props) -> props.rarity).orElse(super.getRarity(itemStack));
    }
